...
import com.example.bt2_qlnv.adapter.PhongBanAdapter;
import com.example.bt2_qlnv.model.ChucVu;
import java.util.ArrayList;

public class MainActivity extends AppCompatActivity {

    public static final int MO_THEM_NV = 1;
    public static final int MO_SUA_NV = 2;
    public static final int THEM_PASS = 3;
    public static final int SUA_PASS = 4;
    public static final int XEM_DS_NV = 5;
    public static final int UPDATE_PASS = 6;
    public static final int MO_TP_PP = 7;
    public static final int TP_PP_PASS = 8;
    public static final int MO_CHUYENPB = 9;
    public static final int CHUYENPB_PASS = 10;
    ...
    {
        Intent i=new Intent(this, themNV.class);
        startActivityForResult(i, MO_THEM_NV);
    }
    /**
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        //kết quả về
        else if(resultCode==TP_PP_PASS||
                resultCode==UPDATE_PASS)
        {
            //Cách lấy dữ liệu đã học rồi, ko nói lại
            Bundle bundle= data.getBundleExtra("DATA");
    ...
    {
        Intent i=new Intent(this, DSNV.class);
        Bundle bundle=new Bundle();
        bundle.putSerializable("PHONGBAN", pbSelected);
        i.putExtra("DATA", bundle);
        startActivityForResult(i, XEM_DS_NV);
    }
    /**
    ...
    {
        Intent i=new Intent(this, thietlap.class);
        Bundle bundle=new Bundle();
        bundle.putSerializable("PHONGBAN", pbSelected);
        i.putExtra("DATA", bundle);
        startActivityForResult(i, MO_TP_PP);
    }
    /**
